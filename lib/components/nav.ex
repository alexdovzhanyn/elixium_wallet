  ...
  def init(current_scene, opts) do
    ...
    {:ok, %ViewPort.Status{size: {vp_width, height}}} =
      ...
      graph =
        ...
        |> line({{10,240}, {120,240}}, stroke: {2, :black})
        |> text("Transactions", font_size: 20, translate: {15, 260})
        ...
        |> line({{10,475}, {120,475}}, stroke: {2, :black})
        |> text("Keys", font_size: 20, translate: {40, 500})
